---
name: create-pet
description: Generate a digital pet for the current project using BaZi + Tarot + MBTI divination. Use when the user wants to create a pet, summon a new companion, or generate a digital pet.
---
...
```bash
npx tsx plugins/anything-digital-pet/bin/create-pet.ts "<projectContext>" --mbti <MBTI>
```
...
```bash
# 1. Check common install locations and PATH
